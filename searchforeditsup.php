...
<form action="searchforeditsup.php"  method="post" name="search" onsubmit="return ValidateForm(this);">
...
<td align="center"><a href="editsitinfobysup.php?NE=<?php echo $row["NE"]; ?>" >Edit</a></td><td align="center">
</tr>
<?php $count++; } }?>
</tbody>
</table>
